# -*- coding: utf-8 -*-
"""
Created on Sun Jan 28 01:42:56 2018

@author: Administrator
"""
#Data set is from UCI machine learning repo Breast Cancer Wisconsin (Diagnostic)
...
fname = "F:\\517\cancer2.xlsx"
def getData(fname): # getData from the xlsx
    
    df = pd.read_excel('cancer1.xlsx', sheet_name='Sheet1')
    df = df.values
    yTr = df[:,0:1]
    xTr = df[:,1:31]
    return xTr, yTr
